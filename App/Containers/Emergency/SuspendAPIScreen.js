            ...
            content = (
                <View style={styles.container}>
                    ...
                    <Text style={[styles.h3, { marginTop: size(20) }]}>
                        You are suspending your API. This will stop any new
                        orders to come in to the system.{'\n\n'}
                        After suspending your API, you can recover it by
                        clicking “RECOVER API” on Emergency tab.
                    </Text>
                    <Button
                        style={styles.button}
            ...
            content = (
                <View style={styles.container}>
                    ...
                    <Text style={[styles.h3, { marginTop: 66 }]}>
                        ...
                        In order to recover your API, go to Emergency tab then
                        click “RECOVER API”.
                    </Text>
                    <Button
                        style={styles.button}
